...
{0xF0,0x90,0x90,0x90,0xF0,4},   //0
{0xC0,0x40,0x40,0x40,0x40,2},   //1
{0xF0,0x10,0xF0,0x80,0xF0,4},   //2
{0xF0,0x10,0x70,0x10,0xF0,4},   //3
{0x90,0x90,0xF0,0x10,0x10,4},   //4
{0xF0,0x80,0xF0,0x10,0xF0,4},   //5
{0xF0,0x80,0xF0,0x90,0xF0,4},   //6
{0xF0,0x10,0x10,0x10,0x10,4},   //7
{0xF0,0x90,0xF0,0x90,0xF0,4},   //8
{0xF0,0x90,0xF0,0x10,0xF0,4},   //9
...
{0xF0,0x90,0xF0,0x90,0x90,4},   //A
{0xE0,0xA0,0xF0,0x90,0xF0,4},   //B
{0xF0,0x80,0x80,0x80,0xF0,4},   //C
{0xE0,0x90,0x90,0x90,0xE0,4},   //D
{0xF0,0x80,0xE0,0x80,0xF0,4},   //E
{0xF0,0x80,0xE0,0x80,0x80,4},   //F
{0xF0,0x80,0xB0,0x90,0xF0,4},   //G
{0x90,0x90,0xF0,0x90,0x90,4},   //H
{0xE0,0x40,0x40,0x40,0xE0,3},   //I
{0x30,0x10,0x10,0x10,0xE0,4},   //J
{0x90,0x90,0xE0,0x90,0x90,4},   //K
{0x80,0x80,0x80,0x80,0xF0,4},   //L
{0x88,0xD8,0xA8,0x88,0x88,5},   //M
{0x90,0xD0,0xB0,0x90,0x90,4},   //N
{0xF0,0x90,0x90,0x90,0xF0,4},   //O
{0xF0,0x90,0xF0,0x80,0x80,4},   //P
{0xF0,0x90,0x90,0x90,0xF8,5},   //Q
{0xF0,0x90,0xE0,0x90,0x90,4},   //R
{0xF0,0x80,0xF0,0x10,0xF0,4},   //S
...
int DrawStrRA(char str[40] ,int x,int y,const char* clid, const char* shadow)
{
  int xx=x;
  for (int i=0,j=strlen(str); i!=j; i++ )
  {
    xx=xx-GetWidth(str[j-i-1])-1;
    DrawChar(xx+1,y+1,str[j-i-1],shadow);
    DrawChar(xx,y,str[j-i-1],clid);
  }
  return(xx);  
}
...
int DrawStrShadowed(char str[40] ,int x,int y,const char* clid, const char* shadow)
{
  int xx=x;
  for (int i=0; i!=strlen(str); i++ )
  {
    DrawChar(xx+1,y+1,str[i],shadow);
    DrawChar(xx,y,str[i],clid);
    xx=xx+GetWidth(str[i])+1;
  }
  return(xx); 
